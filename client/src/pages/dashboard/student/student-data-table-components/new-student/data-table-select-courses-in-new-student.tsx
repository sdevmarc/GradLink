...
import { DataTableToolbarSelectCoursesInNewStudent } from './data-table-toolbar-select-courses-in-new-student'
...
export function DataTableSelectCoursesInNewStudent<TData, TValue>({
    columns,
    data,
    fetchAddedCourses,
    resetSelection,
    ...
    return (
        <div className="w-full flex flex-col gap-2 border py-2 px-4 rounded-md">
            ...
            <DataTableToolbarSelectCoursesInNewStudent table={table} />
