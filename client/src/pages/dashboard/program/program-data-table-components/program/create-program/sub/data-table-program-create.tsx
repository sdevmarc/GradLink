...
export function DataTableCreateProgramInCourse<TData, TValue>({
    columns,
    data,
    fetchCheck,
    resetSelection,
    ...
    React.useEffect(() => {
        ...
        const programs = selectedRows.map(row => {
            ...
            const { _id, code, descriptiveTitle, residency } = original
            return { _id, code, descriptiveTitle, residency }
        })
