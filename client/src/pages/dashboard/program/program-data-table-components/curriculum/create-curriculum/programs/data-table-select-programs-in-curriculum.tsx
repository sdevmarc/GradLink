...
import { DataTableToolbarSelectProgramsInCurriculum } from './data-table-toolbar-select-programs-in-curriculum'
...
export function DataTableSelectProgramsInCurriculum<TData, TValue>({
    ...
    return (
        <div className="w-full flex flex-col gap-2">
            <DataTableToolbarSelectProgramsInCurriculum table={table} />
