...
import { DataTableToolbarCreateCourseOffered } from './data-table-toolbar-create-course-offered.'
...
export function DataTableCreateCourseOffered<TData, TValue>({
    columns,
    data,
    fetchCourses,
    ...
    return (
        <div className="w-full flex flex-col gap-4">
            <DataTableToolbarCreateCourseOffered table={table} />
