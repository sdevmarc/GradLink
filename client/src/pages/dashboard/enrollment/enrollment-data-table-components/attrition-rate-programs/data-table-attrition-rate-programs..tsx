...
import { DataTableToolbarAttritionRatePrograms } from './data-table-toolbar-attrition-rate-programs.'
...
export function DataTableAttritionRatePrograms<TData, TValue>({
    columns,
    data
    ...
    return (
        <div className="w-full flex flex-col gap-4">
            <DataTableToolbarAttritionRatePrograms table={table} />
