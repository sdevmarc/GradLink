...
import { DataTableToolbarCurrentlyEnrolled } from './data-table-toolbar-currently-enrolled'

interface DataTableProps<TData, TValue> {
    columns: ColumnDef<TData, TValue>[]
    data: TData[],
    fetchCheck: (e: IAPIStudents[]) => void
    resetSelection: boolean
    onResetComplete: () => void
}

export function DataTableStudentCurrentEnrolled<TData, TValue>({
    columns,
    data,
    fetchCheck,
    resetSelection,
    ...
    React.useEffect(() => {
        ...
        const current_enrolled = selectedRows.map(row => {
    ...
    return (
        <div className="w-full flex flex-col gap-4">
            <DataTableToolbarCurrentlyEnrolled table={table} isrows={isrows} />
