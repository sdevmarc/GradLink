...
import { DataTableToolbarAttritionRateCourses } from './data-table-toolbar-attrition-rate-courses.'
...
export function DataTableAttritionRateCourses<TData, TValue>({
    columns,
    data
    ...
    return (
        <div className="w-full flex flex-col gap-4">
            <DataTableToolbarAttritionRateCourses table={table} />
